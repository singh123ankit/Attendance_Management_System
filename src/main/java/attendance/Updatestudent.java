...
public class Updatestudent extends JFrame implements ActionListener{
    ...
    public Updatestudent() {
        ...
        this.setLayout(null);
        c1.setBackground(c);
        JLabel lb1 = new JLabel("Update Student");
    ...
    public void actionPerformed(ActionEvent ae{
         ...
         String str7 = "update student set name = ?, stream = ?, session = ?, mobile_number = ? where roll_number = ?";
         PreparedStatement rms = con.prepareStatement(str7);
         if(str1.equals("UPDATE")){
             int a = JOptionPane.showConfirmDialog(this,"Do You Want to Update","Close Window",JOptionPane.YES_NO_OPTION);
             if(a==JOptionPane.YES_OPTION){
             rms.setString(1,str2);
             rms.setString(2,str3);
             rms.setString(3,str4);
             rms.setString(4,str5);
             rms.setString(5,str8);
             rms.executeUpdate();
